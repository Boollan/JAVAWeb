...
public class SQLConfig {
    ...
    public static String MYSQL_JDBCSQL="jdbc:mysql://fly.boollan.pro:3306/Boollan";
    public static String MYSQL_USER="Boollan";
    public static String MYSQL_PASSWORD="3838538+.";
