...
<%--            <p style="color: red;">注意: 请不要将账号租借给他人，否则会被封禁.</p>--%>
            ...
            <div class="col-lg-10 popover-content " style="margin-left: 7%">
                <div class="input-group"  >
                    ...
                    <input type="text" class="form-control" placeholder="数据加载中" disabled="value" value="<%= session.getAttribute("UserName")%>" aria-describedby="basic-addon1" >
                </div>
                <br>
                <div class="input-group">
                    <span class="input-group-addon" id="basic-addon2">CDK:</span>
                    <input type="email" id="money_key" class="form-control" value="" placeholder="请输入CDK" aria-describedby="basic-addon1" >
                </div>
                <br>

                <button type="button" id="money_btn" class="btn btn-default" style="margin-left: 40%; color: #337AB7; width: 125px;height: 50px">兑换</button>
            </div>
        </div>
    </div>
