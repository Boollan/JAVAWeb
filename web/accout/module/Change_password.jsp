        ...
        <div class="panel-body">
            ...
            <div class="col-lg-10 popover-content " style="margin-left: 7%">
                <div class="input-group"  >
                    ...
                    <input type="text" id="Password_username" class="form-control" placeholder="Username" disabled="value" value="<%= session.getAttribute("UserName")%>" aria-describedby="basic-addon1" >
                </div>
                <br>
                <div class="input-group">
                    <span class="input-group-addon" id="basic-addon2">旧密码:</span>
                    <input type="password" id="password-pwd-old" class="form-control" placeholder="请输入旧密码" aria-describedby="basic-addon1" >
                </div>
                <br>
                <div class="input-group">
                    <span class="input-group-addon" id="basic-addon3">新密码:</span>
                    <input type="password" id="password-pwd-new" class="form-control" placeholder="请输入新密码" aria-describedby="basic-addon1" >
                </div>
                <br>
                <div class="input-group">
                    <span class="input-group-addon" id="basic-addon4">确认密码:</span>
                    <input type="password" id="password-confirm" class="form-control" placeholder="请输入确认密码" aria-describedby="basic-addon1" >
                </div>
                <br>
                <button type="button" id="passowrd-btn" class="btn btn-default" style="margin-left: 40%; color: #337AB7; width: 125px;height: 50px">确认修改密码</button>
            </div>
        </div>
    </div>
    <div>
