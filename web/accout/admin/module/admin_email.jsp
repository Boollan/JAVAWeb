        ...
        <div class="panel-body">
            <div class="col-lg-10 popover-content " style="margin-left: 7%">
                ...
                <div class="input-group"  >
                    ...
                    <input type="text" id="Password_username" class="form-control" placeholder="要修改的用户名"   aria-describedby="basic-addon1" >
                </div>
                <br>
                <div class="input-group">
                    <span class="input-group-addon" id="basic-addon2">邮箱:</span>
                    <input type="password" id="password-pwd-old" class="form-control" placeholder="请输入新的邮箱" aria-describedby="basic-addon1" >
                </div>
                <br>
                <button type="button" id="passowrd-btn" class="btn btn-default" style="margin-left: 40%; color: #337AB7; width: 125px;height: 50px">确认强制更改</button>
            </div>
        </div>
    </div>
